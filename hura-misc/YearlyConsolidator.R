...
gpx_path <- "C:/Users/micha/Desktop/mph_json/2015/"
gpx_files <- list.files(gpx_path)

#create the master output file for GIS conversion
output_file_name <- "C:/Users/micha/Desktop/master_2015.json"
...
for (file in gpx_files) {
  ...
  #build output file
  cat(json_data, file = output_file_name, sep="", append = TRUE)
  rm("json_data")
